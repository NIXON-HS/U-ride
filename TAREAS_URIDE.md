...
- [ ] **BD-1: Esquema SQL y Base de Trazabilidad**
...
- [ ] **BK-1: Lógica del Registro Institucional**
...
- [ ] **BK-3: Gestión de Perfil de Usuario**
  - **📌 Cubre:** **RF2**.
...
- [ ] **BK-4: Publicar un Viaje (Conductor)**
...
- [ ] **BK-5: Filtrador Geográfico Inverso (Pasajero)**
...
- [ ] **BK-6 & BK-7: Enviar, Aceptar y Confirmar**
...
- [ ] **BK-8 & BK-9: Evaluaciones y Motor de Reputación**
...
- [ ] **BK-11: Portal Backend del Administrador**
...
- [ ] **MOB-1: Autenticación, Usabilidad Sencilla**
...
- [ ] **MOB-2: Flujo y Cartillas de Viaje**
...
- [ ] **MOB-3: Buzón de Control del Conductor**
  - **📌 Cubre:** **RF6** y **RF7**.
...
- [ ] **FE-1: Dashboard del Moderador Web**
...
- [ ] **EX-1: Procesador Analítico de Pagos**
...
- [ ] **EX-2: Tracker de Interfaz Espacial Activa**
